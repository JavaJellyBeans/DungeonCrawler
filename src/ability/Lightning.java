...
public class Lightning extends Ability {
	...
	public Lightning(){this.level = 0; this.helpful = false; this.aoe = false;}
	...
	public String getDescription() {
		// TODO Auto-generated method stub
		return "A lightning strike that deals more damage the lower the enemy's hp is.\tBase Damage - 10";
	}
	
	public String toString(){
		return "Lightning:\t" + getDescription();
	}
