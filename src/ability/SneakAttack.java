...
public class SneakAttack extends Ability {

	public SneakAttack(){this.level = 1; this.helpful = false; this.aoe = false;}
	...
	public void use(Character user, Character target) {
		...
		if(hit < 100 - target.getAgi()) {
			...
			int damage = 10*((int) Math.round((double) user.getDex()/target.getDef()));
	...
	public String toString(){
		return "Sneak Attack:\t" + getDescription();
	}
