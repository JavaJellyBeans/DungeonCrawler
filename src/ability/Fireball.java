...
public class Fireball extends Ability {
	...
	public Fireball(){this.level = 0; this.helpful = false; this.aoe = false;}
	...
	public String getDescription() {
		// TODO Auto-generated method stub
		return "A basic fireball that deals damage that scales with level\tBase Damage - 10";
	}
	
	public String toString(){
		return "Fireball:\t" + getDescription();
	}
