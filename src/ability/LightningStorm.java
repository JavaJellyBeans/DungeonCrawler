...
public class LightningStorm extends Ability {
	...
	public LightningStorm(){this.level = 0; this.helpful = false; this.aoe = true;}
	...
	public void use(Character user, Character target) {
		...
		if(hit < 100 - target.getAgi()) {
			...
			int damage = 10*((int) Math.round((double) target.getHpmax()/target.getHp()));
	...
	public String getDescription() {
		// TODO Auto-generated method stub
		return "A lightning strike that deals more damage to each enemy the lower the enemy's hp is.\tBase Damage - 10";
	}
	
	public String toString(){
		return "Lightning Storm:\t" + getDescription();
	}
